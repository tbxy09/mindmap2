...
var MindMap = function () {
  ...
  _createClass(MindMap, [{
    ...
    value: function _divideBalancedNodes(root) {
      ...
      var left = root.children.slice(0, divideIndex + 1);
      var right = root.children.slice(divideIndex + 1);
      return [left, right];
    }
  }, {
...
var MongoClient = require('mongodb').MongoClient
    MongoClient.connect('mongodb://192.168.2.100:27017/Tb_xy09', function(err, db) {
        ...
        col.insertOne({a:1},function(err,docs){
            test.equal(null,err)
...
/*          chrome.storage.local.set({
          ...
          MongoClient.connect('mongodb://192.168.2.100:27017/Tb_xy09',function(){
            var col = db.collection('insert_one');
            col.find().toArray(function(err,docs){
              docs[0].contentMap = contentMap
              db.close()
            })
          })
